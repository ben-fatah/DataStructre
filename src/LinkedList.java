public class LinkedList<T> implements List<T> {
  ...
  public boolean full() {
    ...
    // the maximum number allowed then flag is set to true otherwise false. output:
    // flag.
    return false;
  }
  ...
  public boolean last() {
    ...
    // input: none. requires: L is not empty. Results: if the last element is the
    // current
